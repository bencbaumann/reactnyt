...
var makeResolveMatcher = function makeResolveMatcher (
  ...
  isNot,
  actual) {
  return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
    function _callee () {
      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) { args[_key] = arguments[_key] } var matcherStatement, result; return _regenerator2.default.wrap(function _callee$ (_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              makeThrowingMatcher(matcher, isNot, result).apply(null, args)); case 14:case 'end':return _context.stop()
          }
        }
...
var makeRejectMatcher = function makeRejectMatcher (
  ...
  return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(
    function _callee2 () {
      for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) { args[_key2] = arguments[_key2] } var matcherStatement, result; return _regenerator2.default.wrap(function _callee2$ (_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              utils.printReceived(result)))); case 14:case 'end':return _context2.stop()
          }
        }
