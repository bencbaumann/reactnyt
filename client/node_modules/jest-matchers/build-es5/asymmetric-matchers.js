...
function AsymmetricMatcher () {
  (0, _classCallCheck3.default)(this, AsymmetricMatcher)
  this.$$typeof = (0, _for2.default)('jest.asymmetricMatcher')
}; var

  Any = (function (_AsymmetricMatcher) {
    (0, _inherits3.default)(Any, _AsymmetricMatcher)

    function Any (sample) {
      (0, _classCallCheck3.default)(this, Any); var _this = (0, _possibleConstructorReturn3.default)(this, (Any.__proto__ || (0, _getPrototypeOf2.default)(Any)).call(this))
    ...
    }(0, _createClass3.default)(Any, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
  ...
  }(AsymmetricMatcher)); var

  Anything = (function (_AsymmetricMatcher2) {
    (0, _inherits3.default)(Anything, _AsymmetricMatcher2); function Anything () { (0, _classCallCheck3.default)(this, Anything); return (0, _possibleConstructorReturn3.default)(this, (Anything.__proto__ || (0, _getPrototypeOf2.default)(Anything)).apply(this, arguments)) }(0, _createClass3.default)(Anything, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
        other) {
  ...
  ArrayContaining = (function (_AsymmetricMatcher3) {
    (0, _inherits3.default)(ArrayContaining, _AsymmetricMatcher3)

    function ArrayContaining (sample) {
      (0, _classCallCheck3.default)(this, ArrayContaining); var _this3 = (0, _possibleConstructorReturn3.default)(this, (ArrayContaining.__proto__ || (0, _getPrototypeOf2.default)(ArrayContaining)).call(this))

      _this3.sample = sample; return _this3
    }(0, _createClass3.default)(ArrayContaining, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
  ...
  ObjectContaining = (function (_AsymmetricMatcher4) {
    (0, _inherits3.default)(ObjectContaining, _AsymmetricMatcher4)

    function ObjectContaining (sample) {
      (0, _classCallCheck3.default)(this, ObjectContaining); var _this4 = (0, _possibleConstructorReturn3.default)(this, (ObjectContaining.__proto__ || (0, _getPrototypeOf2.default)(ObjectContaining)).call(this))

      _this4.sample = sample; return _this4
    }(0, _createClass3.default)(ObjectContaining, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
  ...
  StringContaining = (function (_AsymmetricMatcher5) {
    (0, _inherits3.default)(StringContaining, _AsymmetricMatcher5)

    function StringContaining (sample) {
      (0, _classCallCheck3.default)(this, StringContaining); var _this5 = (0, _possibleConstructorReturn3.default)(this, (StringContaining.__proto__ || (0, _getPrototypeOf2.default)(StringContaining)).call(this))

      if (!isA('String', sample)) {
        throw new Error('Expected is not a string')
      }
      _this5.sample = sample; return _this5
    }(0, _createClass3.default)(StringContaining, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
  ...
  StringMatching = (function (_AsymmetricMatcher6) {
    (0, _inherits3.default)(StringMatching, _AsymmetricMatcher6)

    function StringMatching (sample) {
      (0, _classCallCheck3.default)(this, StringMatching); var _this6 = (0, _possibleConstructorReturn3.default)(this, (StringMatching.__proto__ || (0, _getPrototypeOf2.default)(StringMatching)).call(this))
    ...
    }(0, _createClass3.default)(StringMatching, [{ key: 'asymmetricMatch',
      value: function asymmetricMatch (
