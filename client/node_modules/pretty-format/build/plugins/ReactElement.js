...
const escapeHTML = require('./lib/escapeHTML') /**
                                                 ...
                                                 *
                                                 *
                                                 */const reactElement = Symbol.for('react.element'); function traverseChildren (opaqueChildren, cb) {
  if (Array.isArray(opaqueChildren)) { opaqueChildren.forEach(child => traverseChildren(child, cb)) } else if (opaqueChildren != null && opaqueChildren !== false) {
    cb(opaqueChildren)
  }
}
