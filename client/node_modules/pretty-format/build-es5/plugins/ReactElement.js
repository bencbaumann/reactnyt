...
var escapeHTML = require('./lib/escapeHTML') /**
                                               ...
                                               *
                                               *
                                               */var reactElement = (0, _for2.default)('react.element'); function traverseChildren (opaqueChildren, cb) {
  if (Array.isArray(opaqueChildren)) { opaqueChildren.forEach(function (child) { return traverseChildren(child, cb) }) } else if (opaqueChildren != null && opaqueChildren !== false) {
    cb(opaqueChildren)
  }
}
