...
module.exports = PrettyError = (function () {
  ...
  PrettyError.prototype.skipPackage = function () {
    ...
    packages = arguments.length >= 1 ? __slice.call(arguments, 0) : []
  ...
  PrettyError.prototype.skipPath = function () {
    ...
    paths = arguments.length >= 1 ? __slice.call(arguments, 0) : []
  ...
  PrettyError.prototype.skip = function () {
    ...
    callbacks = arguments.length >= 1 ? __slice.call(arguments, 0) : []
