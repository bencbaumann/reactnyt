(function () {
  ...
  Gradient = (function (superClass) {
    ...
    Gradient.prototype.replaceFirst = function () {
      ...
      params = arguments[0], words = arguments.length >= 2 ? slice.call(arguments, 1) : []
    ...
    Gradient.prototype.newDirection = function (params) {
      ...
      for (i = j = 2, ref = params.length; ref >= 2 ? j < ref : j > ref; i = ref >= 2 ? ++j : --j) {
    ...
    Gradient.prototype.fixDirection = function (params) {
      ...
      params.splice(0, 2)
      results = []
      for (i = j = 0, ref = params.length; ref >= 0 ? j < ref : j > ref; i = ref >= 0 ? ++j : --j) {
        if (params[i].type === 'div') {
          break
        }
        if (params[i].type === 'word') {
    ...
    Gradient.prototype.fixRadial = function (params) {
      ...
      first = params[0]
      second = []
      for (i = j = 4, ref = params.length; ref >= 4 ? j < ref : j > ref; i = ref >= 4 ? ++j : --j) {
        if (params[i].type === 'div') {
          break
        } else {
