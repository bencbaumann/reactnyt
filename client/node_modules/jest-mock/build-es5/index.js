 ...
 *
 *
 */var RESERVED_KEYWORDS = (0, _assign2.default)((0, _create2.default)(null), { arguments: true,
  await: true,
  break: true,
  case: true,
  catch: true,
...
function getSlots (object) {
  ...
  /**
    ...
    function ModuleMockerClass (global) {
      (0, _classCallCheck3.default)(this, ModuleMockerClass)
      this._environmentGlobal = global
      this._mockState = new _weakMap2.default()
      this._mockConfigRegistry = new _weakMap2.default()
      this.ModuleMocker = ModuleMockerClass
    }(0, _createClass3.default)(ModuleMockerClass, [{ key: '_ensureMockConfig',
      ...
      value: function _ensureMockState (
      ...
      metadata.type === 'undefined') {
        ...
        metadata.members.prototype.members || {}
          ...
          f.mockRestore = restore || function () {}
    ...
    /**
      ...
      value: function generateFromMetadata (
        _metadata) {
        var callbacks = []
        var refs = {}
