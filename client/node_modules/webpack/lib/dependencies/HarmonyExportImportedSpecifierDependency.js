...
HarmonyExportImportedSpecifierDependency.Template = class HarmonyExportImportedSpecifierDependencyTemplate {
  ...
  getContent (dep) {
    ...
    if (dep.originModule.usedExports) {
      ...
      if (activeExports.length > 0) { content += 'if(' + JSON.stringify(activeExports.concat('default')) + '.indexOf(__WEBPACK_IMPORT_KEY__) < 0) ' } else { content += "if(__WEBPACK_IMPORT_KEY__ !== 'default') " }
