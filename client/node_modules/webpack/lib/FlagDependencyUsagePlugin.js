    ...
    compiler.plugin('compilation', compilation => {
      compilation.plugin('optimize-modules-advanced', modules => {
        ...
        function processModule (module, usedExports) {
          module.used = true
          if (module.usedExports === true) { return } else if (usedExports === true) { module.usedExports = true } else if (Array.isArray(usedExports)) {
            var old = module.usedExports ? module.usedExports.length : -1
            module.usedExports = addToSet(module.usedExports || [], usedExports)
            if (module.usedExports.length === old) { return }
          } else if (Array.isArray(module.usedExports)) { return } else { module.usedExports = false }
