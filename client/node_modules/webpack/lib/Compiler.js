...
class Compiler extends Tapable {
  ...
  createChildCompiler (compilation, compilerName, compilerIndex, outputOptions, plugins) {
    ...
    if (this.records[relativeCompilerName][compilerIndex]) { childCompiler.records = this.records[relativeCompilerName][compilerIndex] } else { this.records[relativeCompilerName].push(childCompiler.records = {}) }

    if (this.cache) {
      if (!this.cache.children) this.cache.children = {}
      if (!this.cache.children[compilerName]) this.cache.children[compilerName] = []
      if (this.cache.children[compilerName][compilerIndex]) { childCompiler.cache = this.cache.children[compilerName][compilerIndex] } else { this.cache.children[compilerName].push(childCompiler.cache = {}) }
    }
