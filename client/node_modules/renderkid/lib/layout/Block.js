...
module.exports = Block = (function () {
  ...
  Block.prototype._writeInline = function (str) {
    ...
    if (m = remaining.match(/^\n+/)) {
      for (i = j = 1, ref = m[0].length; ref >= 1 ? j <= ref : j >= ref; i = ref >= 1 ? ++j : --j) {
        this._writeLine('')
      }
    ...
    while (remaining.length > 0) {
      if (m = remaining.match(/^[^\n]+/)) {
        ...
        for (i = k = 1, ref1 = m[0].length; ref1 >= 1 ? k < ref1 : k > ref1; i = ref1 >= 1 ? ++k : --k) {
          this._writeLine('')
        }
        remaining = remaining.substr(m[0].length, remaining.length)
      }
    ...
    if (lineBreaksToAppend > 0) {
      for (i = l = 1, ref2 = lineBreaksToAppend; ref2 >= 1 ? l <= ref2 : l >= ref2; i = ref2 >= 1 ? ++l : --l) {
        this._writeLine('')
      }
    }
  }
