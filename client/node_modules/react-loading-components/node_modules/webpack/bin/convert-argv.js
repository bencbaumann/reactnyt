...
module.exports = function (yargs, argv, convertOptions) {
  ...
  function processConfiguredOptions (options) {
    ...
    if (typeof argv['watch-poll'] !== 'undefined') {
      options.watchOptions = options.watchOptions || {}
      if (argv['watch-poll'] === 'true' || argv['watch-poll'] === '') { options.watchOptions.poll = true } else if (!isNaN(argv['watch-poll'])) { options.watchOptions.poll = +argv['watch-poll'] }
    }
  ...
  function processOptions (options) {
    ...
    function mapArgToBoolean (name, optionName) {
      ifArg(name, function (bool) {
        if (bool === true) { options[optionName || name] = true } else if (bool === false) { options[optionName || name] = false }
      })
    }
