      ...
      switch (expr.arguments.length) {
        ...
        case 2:
        {
          ...
          try {
            ...
            if (successExpression) {
              if (successExpression.fn.body.type === 'BlockStatement') { parser.walkStatement(successExpression.fn.body) } else { parser.walkExpression(successExpression.fn.body) }
            }
            old.addBlock(dep)
          } finally {
          ...
          if (errorExpression) {
            if (errorExpression.fn.body.type === 'BlockStatement') { parser.walkStatement(errorExpression.fn.body) } else { parser.walkExpression(errorExpression.fn.body) }
