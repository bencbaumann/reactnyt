  ...
  processFunctionArgument (parser, expression) {
    ...
    if (fnData) {
      parser.inScope(fnData.fn.params.filter((i) => {
        ...
        if (fnData.fn.body.type === 'BlockStatement') { parser.walkStatement(fnData.fn.body) } else { parser.walkExpression(fnData.fn.body) }
      })
      ...
      if (expr.arguments.length === 2 || expr.arguments.length === 3) {
        try {
          ...
          if (!result) {
            ...
            if (parser.state.module) { parser.state.module.errors.push(new UnsupportedFeatureWarning(parser.state.module, "Cannot statically analyse 'require(..., ...)' in line " + expr.loc.start.line)) }
            dep = null
            return true
          }
