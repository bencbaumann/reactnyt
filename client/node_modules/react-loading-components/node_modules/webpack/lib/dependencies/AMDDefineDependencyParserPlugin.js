    ...
    parser.plugin('call define', (expr) => {
      ...
      if (fn && isUnboundFunctionExpression(fn)) {
        ...
        parser.inScope(fnParams, () => {
          ...
          if (fn.body.type === 'BlockStatement') { parser.walkStatement(fn.body) } else { parser.walkExpression(fn.body) }
        })
        ...
        parser.inScope(fn.callee.object.params.filter((i) => ['require', 'module', 'exports'].indexOf(i.name) < 0), () => {
          parser.scope.renames = fnRenames
          parser.scope.inTry = inTry
          if (fn.callee.object.body.type === 'BlockStatement') { parser.walkStatement(fn.callee.object.body) } else { parser.walkExpression(fn.callee.object.body) }
        })
