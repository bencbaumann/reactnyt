    ...
    parser.plugin(['call System.import', 'import-call'], (expr) => {
      ...
      if (importOptions) {
        if (typeof importOptions.webpackChunkName !== 'undefined') {
          if (typeof importOptions.webpackChunkName !== 'string') { parser.state.module.warnings.push(new UnsupportedFeatureWarning(parser.state.module, `\`webpackChunkName\` expected a string, but received: ${importOptions.webpackChunkName}.`)) } else { chunkName = importOptions.webpackChunkName }
        }
        if (typeof importOptions.webpackMode !== 'undefined') {
          if (typeof importOptions.webpackMode !== 'string') { parser.state.module.warnings.push(new UnsupportedFeatureWarning(parser.state.module, `\`webpackMode\` expected a string, but received: ${importOptions.webpackMode}.`)) } else { mode = importOptions.webpackMode }
        }
      }
