  ...
  static jsonToString (obj, useColors) {
    ...
    const processModuleContent = (module, prefix) => {
      if (Array.isArray(module.providedExports)) {
        ...
        if (module.providedExports.length === 0) { colors.cyan('[no exports]') } else { colors.cyan(`[exports: ${module.providedExports.join(', ')}]`) }
        newline()
      }
      if (module.usedExports !== undefined) {
        if (module.usedExports !== true) {
          colors.normal(prefix)
          if (module.usedExports === false || module.usedExports.length === 0) { colors.cyan('[no exports used]') } else { colors.cyan(`[only some exports used: ${module.usedExports.join(', ')}]`) }
          newline()
        }
      }
