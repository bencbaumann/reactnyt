  ...
  function hotCreateModule (moduleId) { // eslint-disable-line no-unused-vars
    var hot = {
      ...
      accept: function (dep, callback) {
        if (typeof dep === 'undefined') { hot._selfAccepted = true } else if (typeof dep === 'function') { hot._selfAccepted = dep } else if (typeof dep === 'object') {
          for (var i = 0; i < dep.length; i++) { hot._acceptedDependencies[dep[i]] = callback || function () {} }
        } else { hot._acceptedDependencies[dep] = callback || function () {} }
      },
      decline: function (dep) {
        if (typeof dep === 'undefined') { hot._selfDeclined = true } else if (typeof dep === 'object') {
