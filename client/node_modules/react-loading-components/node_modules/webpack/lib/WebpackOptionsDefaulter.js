...
class WebpackOptionsDefaulter extends OptionsDefaulter {
  constructor () {
    ...
    this.set('resolve.aliasFields', 'make', (options) => {
      if (options.target === 'web' || options.target === 'webworker') { return ['browser'] } else { return [] }
    })
    this.set('resolve.mainFields', 'make', (options) => {
      if (options.target === 'web' || options.target === 'webworker') { return ['browser', 'module', 'main'] } else { return ['module', 'main'] }
    })
