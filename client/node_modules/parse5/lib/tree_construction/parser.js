...
Parser.prototype._initTokenizerForFragmentParsing = function () {
  ...
  if (tn === $.TITLE || tn === $.TEXTAREA) { this.tokenizer.state = Tokenizer.MODE.RCDATA } else if (tn === $.STYLE || tn === $.XMP || tn === $.IFRAME ||
...
function startTagInHead (p, token) {
  ...
  if (tn === $.HTML) { startTagInBody(p, token) } else if (tn === $.BASE || tn === $.BASEFONT || tn === $.BGSOUND ||
             tn === $.COMMAND || tn === $.LINK || tn === $.META) {
    p._appendElement(token, NS.HTML)
  } else if (tn === $.TITLE) { p._switchToTextParsing(token, Tokenizer.MODE.RCDATA) }
...
function endTagInTable (p, token) {
  ...
  } else if (tn === $.TEMPLATE) { endTagInHead(p, token) } else if (tn !== $.BODY && tn !== $.CAPTION && tn !== $.COL && tn !== $.COLGROUP && tn !== $.HTML &&
