...
Tapable.prototype.applyPlugins0 = function applyPlugins0 (name) {
  var plugins = this._plugins[name]
  if (!plugins) return
  for (var i = 0; i < plugins.length; i++) { plugins[i].call(this) }
}

Tapable.prototype.applyPlugins1 = function applyPlugins1 (name, param) {
  var plugins = this._plugins[name]
  if (!plugins) return
  for (var i = 0; i < plugins.length; i++) { plugins[i].call(this, param) }
}

Tapable.prototype.applyPlugins2 = function applyPlugins2 (name, param1, param2) {
  var plugins = this._plugins[name]
  if (!plugins) return
  for (var i = 0; i < plugins.length; i++) { plugins[i].call(this, param1, param2) }
}
...
Tapable.prototype.applyPluginsWaterfall0 = function applyPluginsWaterfall0 (name, init) {
  ...
  var current = init
  for (var i = 0; i < plugins.length; i++) { current = plugins[i].call(this, current) }
  return current
}
...
Tapable.prototype.applyPluginsWaterfall1 = function applyPluginsWaterfall1 (name, init, param) {
  ...
  if (!plugins) return init
  var current = init
  for (var i = 0; i < plugins.length; i++) { current = plugins[i].call(this, current, param) }
  return current
}
...
Tapable.prototype.applyPluginsWaterfall2 = function applyPluginsWaterfall2 (name, init, param1, param2) {
  ...
  if (!plugins) return init
  var current = init
  for (var i = 0; i < plugins.length; i++) { current = plugins[i].call(this, current, param1, param2) }
  return current
}
